		...
		self.helper.layout = layout.Layout (
			...
			layout.Fieldset(_("Image"),
				...
				layout.HTML(u"""{% load i18n %}
					<p class="help-block">{% trans "Available formats are JPG, GIF, and PNG. 
			...
			layout.Fieldset(_("Contact"),
				...
				layout.Div( bootstrap.PrependedText("phone", """<span class="glyphicon glyphiconearphone">
							</span>""", css_class="inputblock-level" ),
							bootstrap.PrependedText("email", "@", placeholder="contact@example.com",
